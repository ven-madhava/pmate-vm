# 10 Nov
# Added code for task files boards and its API
# -------------------------------------------
...
def api_create_textures(user_id,task_id,picked_ind_string,progress):
    ...
    try:
        ...
        task_board_sp = "TPF"
        task_genid = "N/A"
        task_files_board = feed_to_build_range(task_pats,task_cats,user_id,task_id,task_genid,task_board_name,task_board_sp,no_ideas_per_row=8,no_total_rows=4)
        ...
        try:
            ...
            try:
                ...
                if api_key == vm_api_key:
                    ...
                    storage_client = storage.Client()
                    bucket = storage_client.get_bucket(bucket_name)
                    destination_blob_name = 'linemarkings/'
                    blobs = bucket.list_blobs(prefix=destination_blob_name, delimiter='/')
                    ...
                    try:
                        ...
                        for b in blobs:
                            if '.jpg' in str(b.name).lower():
                                ...
                                stripped_ind = stripped_name[0:stripped_name.index('_')]
                                if str(p_cat_id) == str(stripped_ind):
                                    counter += 1
                                    d[counter] = {}
